...
// MARK: - 设置界面
extension WBVieitorView {

    fileprivate func setupUI() {
        backgroundColor = UIColor(red: 232/255, green: 232/255, blue: 232/255, alpha: 1)
    ...
    fileprivate func startAnimation() {
        ...
        // 动画不完成不删除，如果 iocnView 被释放，动画会一起销毁！
        // 在设置连续播放的动画非常有用
    ...
    /// 布局
    private func setupAuto() {
        // 2.代码布局要取消 autoresizing
        for v in subviews {
        ...
        // 2>小房子
        addConstraints([NSLayoutConstraint(item: houseIconView,
                                           attribute: .centerX,
                                           relatedBy: .equal,
                                           toItem: iconView,
                                           attribute: .centerX,
        ...
        // 4>注册按钮
        addConstraints([NSLayoutConstraint(item: registerButton,
                                           attribute: .top,
                                           relatedBy: .equal,
                                           toItem: tipLabel,
                                           attribute: .bottom,
        ...
        // 5>登录按钮
        addConstraints([NSLayoutConstraint(item: loginButton,
                                           attribute: .top,
                                           relatedBy: .equal,
                                           toItem: tipLabel,
                                           attribute: .bottom,
